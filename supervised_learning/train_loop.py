...
def mi_train_loop(dataloader, model, loss_fn, optimizer, writer, epoch, device):
  size = len(dataloader.dataset)
  model.train()
  # print(model)
  for batch, sample in enumerate(dataloader):
...
def mnist_train_loop(dataloader, model, loss_fn, optimizer, writer, epoch, device):
  size = len(dataloader.dataset)
  model.train()
  # print(model)
  for batch, sample in enumerate(dataloader):
